...
save_path = "./"+str(random_seed)+"_"+str(number_of_ctrl_elements)+"_Ponds_Fig2"
os.mkdir(save_path)
...
if number_of_ctrl_elements == 11:
    ...
    ctrl_elements = ["93-50077", "93-50076", "93-50081", "93-49921", "93-50074", '93-49868', '93-49919', '93-90357', '93-90358', '93-50225'] 
elif number_of_ctrl_elements == 9:
    ctrl_elements = ["93-50077", "93-50076", "93-50081", "93-49921", "93-50074", '93-49868', '93-49919', '93-90357', '93-90358']
elif number_of_ctrl_elements == 8:
    ctrl_elements = ["93-50077", "93-50076", "93-50081", "93-49921", "93-50074", '93-49868', '93-49919', '93-90357']
elif number_of_ctrl_elements == 7:
    ctrl_elements = ["93-50077", "93-50076", "93-50081", "93-49921", "93-50074", '93-49868', '93-49919']
elif number_of_ctrl_elements == 6:
    ctrl_elements = ["93-50077", "93-50076", "93-50081", "93-49921", "93-50074", '93-49868']
...
myBopt.run_optimization(save_path, max_iter=iterations, save_inter_models=True, intervals=model_save_interval, verbosity=verbo)
...
index = np.linspace(model_save_interval, iterations, int(iterations/model_save_interval), dtype=int)
pre = []
actions = []
...
for ind in index:
    ...
    data_controlled = swmm_execute(temp_myBopt.x_opt.reshape(1,number_of_ctrl_elements))
...
np.save(save_path + "/performance_bayopt_" + str(number_of_ctrl_elements)+ "_RandomSeed_"+str(random_seed), data_trained)
