...
data = np.load("./Prototyping-Notebooks/data_emp.npy", allow_pickle=True).item()
...
plt.ylim([-0.5, 1.5])
plt.plot(data["sample_x"], data["sample_y"], "o", color="#383e56", markersize=1.50)
...
plt.plot(data["sample_x"], data["sample_y"], "o", color="#383e56", markersize=0.50)
