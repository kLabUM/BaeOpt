function inp = rain_pds_a2_inp_transform(n_sample, i_duration, i_return_period)
% Requires
...
%        Duration is: [5min    10min   15min   30min   60min   2hr     3hr     6hr     12hr    24hr    2day...] 
%
...
total_in_rainfall = rain_pds_a2_sample(i_duration, i_return_period, n_sample,'mean');
